...
CREATE TABLE ExecutionOrder (RunOrder INTEGER, Name TEXT);
...
-- Table: InsertViews
CREATE TABLE InsertViews (RunOrder INTEGER, ViewName TEXT, InsertTable TEXT, ColumnString TEXT, ValueString TEXT, WhereStatement TEXT);
...
-- Table: QAQC_Queries
CREATE TABLE QAQC_Queries (QueryOrder REAL, QueryName TEXT, Method TEXT, Function TEXT, Description TEXT, DescriptionSub TEXT, ExportID TEXT, Field TEXT, CorrectValue TEXT);
...
-- Table: tblEcolSites
CREATE TABLE tblEcolSites (EcolSite TEXT, SiteName TEXT, DateModified NUMERIC DEFAULT NULL, DateComplete NUMERIC DEFAULT NULL);
...
-- Table: tblPlotTags
CREATE TABLE tblPlotTags (PlotKey TEXT, Tag TEXT);

-- Table: tblQualDetail
CREATE TABLE tblQualDetail (RecKey TEXT, Seq INTEGER, Rating REAL, SSSWt REAL, SSSVxW REAL, HFWt REAL, HFVxW REAL, BIWt REAL, BIVxW REAL, Comment TEXT);
